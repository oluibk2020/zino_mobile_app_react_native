  ...
  return (
    <SafeAreaView style={tw`flex-1 bg-gray-50`}>
      <ScrollView contentContainerStyle={tw`p-5 pb-10`}>
        ...
        <View style={[styles.card, tw`mt-6 bg-purple-50 border-purple-200`]}>
          <View style={tw`flex-row items-center mb-3`}>
            <Ionicons
          ...
          >
            <Ionicons
              ...
              style={tw`mr-2`}
            />
            <Text style={styles.buttonText}>Request Development Services</Text>
          </TouchableOpacity>
        </View>
        ...
        <View style={[styles.card, tw`mt-6 bg-purple-50 border-purple-200`]}>
          ...
          <Text style={tw`text-base text-gray-700 mb-5 text-center`}>
            Have you completed a course and want to receive a certificate? Chat with our team and get a signed verifiable certificate delivered straight to your inbox!
          </Text>
        ...
        <View style={[styles.card, tw`mt-6 bg-red-50 border-red-200`]}>
          <View style={tw`flex-row items-center mb-3`}>
            <Ionicons
